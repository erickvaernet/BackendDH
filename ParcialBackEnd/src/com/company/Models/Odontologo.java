...
public class Odontologo {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && numeroMatricula == that.numeroMatricula && nombre.equals(that.nombre) && apellido.equals(that.apellido);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, numeroMatricula, nombre, apellido);
    }
}
