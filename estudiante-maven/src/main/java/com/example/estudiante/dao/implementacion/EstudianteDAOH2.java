package com.example.estudiante.dao.implementacion;
...
public class EstudianteDAOH2 implements IDao<Estudiante> {
    ...
    private final String DB_URL="jdbc:h2:~/test;INIT=RUNSCRIPT FROM 'create.sql'";
    ...
    public List<Estudiante> buscarTodos() {
        ...
        try {
            ...
            while (rs.next()){
                ...
                String nombreEstudiante= rs.getString("nombre");
                String apellidoEstudiante= rs.getString("apellido");
                Estudiante estudiante= new Estudiante(idEstudiante,nombreEstudiante,apellidoEstudiante);
